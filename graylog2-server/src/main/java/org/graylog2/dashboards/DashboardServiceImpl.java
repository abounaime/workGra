...
public class DashboardServiceImpl extends PersistedServiceImpl implements DashboardService {
    ...
    @Override
    public Dashboard create(String title, String description, String creatorUserId, DateTime createdAt,Boolean favoriteDash)
    {
        ...
        dashboardData.put("favoriteDash",favoriteDash);
