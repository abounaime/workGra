...
public class DashboardImpl extends PersistedImpl implements Dashboard {
    ...
    public static final String FIELD_FAVORITE_DASH = "isFavoriteDash";
    ...
    public Boolean isFavoriteDash() {
        return (Boolean) fields.getOrDefault(FIELD_FAVORITE_DASH, true);
    }

    @Override
    public void setFavoriteDash(Boolean favoriteDash) {
        fields.put(FIELD_FAVORITE_DASH, favoriteDash);
    }
