...
public abstract class CreateDashboardRequest {
    ...
    @JsonCreator
    public static CreateDashboardRequest create(@JsonProperty("title") @NotNull String title,
                                                @JsonProperty("description") @NotNull String description,
                                                @JsonProperty("isFavoriteDash") boolean favoriteDash) {
        return new AutoValue_CreateDashboardRequest(title, description, favoriteDash);
    }
}
