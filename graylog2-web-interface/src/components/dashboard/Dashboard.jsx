...
const Dashboard = React.createClass({
  ...
  _addToFavorite(){
    DashboardsStore.addToFavoriteDash(this.props.dashboard)
  },
  _removeFromFavorite(){
    DashboardsStore.removeFromFavoiteDash(this.props.dashboard)
  ...
  _getDashboardActions() {
    ...
    var favoris
    if(    this.props.dashboard.isFavoriteDash === false) {
      favoris = <MenuItem onSelect={this._addToFavorite}>Add to favorites</MenuItem>
    }
    else
    {

      favoris = <MenuItem onSelect={this._removeFromFavorite}>Remove from favorites</MenuItem>
    }
